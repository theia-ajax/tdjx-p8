...
function play_init()
	...
	ui={
		message={show=false,x=64,y=61,text=""},
		pause_fx={show=false,h=4,y=63,count=150}
	}
...
function play_update(dt)
	...
	-- shooting
	if (paddle.shot_t>0) paddle.shot_t-=dt
...
--[[	
	...
	foreach(balls,function(ball)
		...
		if not ball.stuck and blink(0.25,ball.t) then
			rectfill(tlx,tly-1,brx,bry+1,10)
			rectfill(tlx-1,tly,brx+1,bry,10)
		end
		rectfill(tlx,tly,brx,bry,7)
	end)
...
--		rectfill(tlx,tly,brx,bry,8)
	...
	foreach(balls,function(b)
		if (b.super_t>st) st=b.super_t
	end)
	if st>0 then
		local f=st/super_dur
		rectfill(0,0,3,127*f,6)
	end
	
	if paddle.shots>0 then
		for i=1,max_ammo do
			local c=2
			if (i<=paddle.shots) c=8
			local x=(i-1)%10*3+1
			local y=flr((i-1)/10)*3+1
			rectfill(x,y,x+1,y+1,c)
		end
	end
	
	if ui.pause_fx.show then
		for i=1,ui.pause_fx.count do
			local x=rnd(128)
			local y=gaussian()*ui.pause_fx.h+ui.pause_fx.y
			local w=abs(gaussian())*4+2
			line(x-w,y,x+w,y,7)
		end
	end
...
--		rectfill(0,ui.message.y,127,ui.message.y+4,7)
		print(m,
			ui.message.x-#m*2,
			ui.message.y,
			1)
...
function block_hit(b,kill,side)
	local partcol=9
	if (b.hits>1) partcol=13
	...
	if kill and b.hits>0 then
		block_hit(b,kill,side)
	end
end

function side_vec(side)
	if side==0 then
		return -1,0
	elseif side==1 then
		return 1,0
...
function paddle_update(paddle,dt)
...

...

__map__

...

__music__
03 10114344
